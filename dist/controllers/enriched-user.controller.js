...
exports.enrichedUserController = exports.EnrichedUserController = void 0;
const keycloak_validation_service_1 = require("../services/keycloak-validation.service");
const cpe_backend_service_1 = require("../services/cpe-backend.service");
const data_mapping_service_1 = require("../services/data-mapping.service");
class EnrichedUserController {
    async enrichUserData(req, res) {
        ...
        try {
            ...
            const keycloakValidationService = (0, keycloak_validation_service_1.getKeycloakValidationService)();
            ...
            const processedUserData = data_mapping_service_1.dataMappingService.mapKeycloakUserData(keycloakUserData);
            console.log('🔄 [EnrichedUser] Dados mapeados resultantes:', JSON.stringify(processedUserData, null, 2));
            if (!data_mapping_service_1.dataMappingService.validateUserData(processedUserData)) {
            ...
            let empresasData = [];
            const cpeBackendService = (0, cpe_backend_service_1.getCpeBackendService)();
            ...
            const empresasMapeadas = data_mapping_service_1.dataMappingService.mapCpeEmpresaData(empresasData);
            console.log('🔄 [EnrichedUser] Combinando dados...');
            const enrichedData = data_mapping_service_1.dataMappingService.combineUserAndEmpresaData(processedUserData, empresasMapeadas);
            const frontendSafeData = {
                user: enrichedData.user,
                empresas: enrichedData.empresas,
                metadata: {
            ...
            const dataSummary = data_mapping_service_1.dataMappingService.createDataSummary(enrichedData);
    ...
    async debugEmpresaData(req, res) {
        try {
    ...
    sendError(res, statusCode, message, cpf) {
        const errorResponse = {
            success: false,
            error: message,
...
exports.EnrichedUserController = EnrichedUserController;
exports.enrichedUserController = new EnrichedUserController();
//# sourceMappingURL=enriched-user.controller.js.map