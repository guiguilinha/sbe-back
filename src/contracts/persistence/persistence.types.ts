...
// Relacionamento usuário-empresa (junction table)
...
// Diagnóstico (teste realizado)
export interface Diagnostic {
  id: number;
  user_id: number;
  company_id: number; // Adicionar este campo
  performed_at: string;
...
// Estrutura de entrada do frontend (diagnóstico completo)
export interface CompleteDiagnosticRequest {
  ...
  diagnostico: {
    empresaSelecionada: string; // CNPJ da empresa para este teste
